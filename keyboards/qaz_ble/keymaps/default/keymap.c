...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_space(
    ...
    KC_NO, KC_CAPS, KC_TAB, LT(_NAV, KC_ENT), LT(_NUM_SYM,KC_SPACE), KC_ENT, KC_SCLN, KC_SLSH
  ),

  [_NUM_SYM] = LAYOUT_split_space(
    KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
    KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_EQUAL, KC_MINS,
    KC_LCBR, KC_LBRC, KC_LPRN, KC_UNDS, KC_RPRN, KC_RBRC, KC_RCBR, KC_SCLN, KC_DOT,
    KC_NO, KC_DEL, KC_CAPS, KC_TRNS, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT
  ),

    [_NAV] = LAYOUT_split_space(
    KC_GESC, KC_2, KC_3, KC_4, KC_5, KC_6, KC_NO, KC_UP, KC_NO, KC_BSPC,
    RGB_TOG, RGB_MOD, RGB_VAI, RGB_SAI, RGB_HUI, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,
    KC_LCBR, KC_LBRC, KC_LPRN, KC_UNDS, KC_RPRN, KC_RBRC, KC_RCBR, KC_SCLN, KC_PIPE,
